...
static mut AUTO_CANNON_ITEM: *const UClass = ptr::null();
...
static mut SEND_END_MISSION_RESULT: *mut UFunction = ptr::null_mut();
...
impl Hooks {
    ...
    unsafe fn find_statics() -> Result<(), Error> {
        ...
        AUTO_CANNON_ITEM = find("Class /Script/FSD.AutoCannon")?.cast();
        ...
        SEND_END_MISSION_RESULT = find("Function /Script/FSD.PlayerStatsComponent.SendEndMissionResult")?.cast();
        Ok(())
    }
}
