...
unsafe fn find_process_remote_function_for_channel(module: &win::Module) -> Result<(), Error> {
    const PATTERN: [Option<u8>; 40] = [Some(0x48), Some(0x8B), Some(0xC4), Some(0x4C), Some(0x89), Some(0x48), Some(0x20), Some(0x4C), Some(0x89), Some(0x40), Some(0x18), Some(0x48), Some(0x89), Some(0x50), Some(0x10), Some(0x48), Some(0x89), Some(0x48), Some(0x08), Some(0x55), Some(0x53), Some(0x56), Some(0x48), Some(0x8D), Some(0xA8), None, None, None, None, Some(0x48), Some(0x81), Some(0xEC), None, None, Some(0x00), Some(0x00), Some(0xF6), Some(0x42), Some(0x30), Some(0x02)];
